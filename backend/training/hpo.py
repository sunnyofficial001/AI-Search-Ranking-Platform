...
def run_hpo(
    X_train, y_train, qids_train, group_train, X_vali, y_vali, qids_vali, group_vali
) -> Dict[str, Dict[str, Any]]:
    """Run HPO for all models and save to models/best_params.json"""
    best_params = {}

    best_params["xgboost"] = optimize_xgboost(X_train, y_train, qids_train, X_vali, y_vali, qids_vali, n_trials=5)
