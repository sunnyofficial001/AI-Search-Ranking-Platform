...
def search_endpoint(req: SearchRequest):
    ...
    for idx, p in enumerate(candidates):
        ...
        # Incorporate interactive mock weight adjustments from payload if present
        if req.weights:
            pointwise = (
    ...
    registry = [
        {
            ...
            "version": "v1.2.0",
            "accuracy": "0.88 NDCG@5",
            "status": "Active",
        },
        {
            "modelName": "MatrixFactorization-Recs",
            "version": "v2.1-latent",
            "accuracy": "0.85 Precision@5",
            "status": "Active",
        },
        {
            "modelName": "RankNet-Pairwise",
            "version": "v0.9.1",
            "accuracy": "0.75 NDCG@5",
            "status": "Staging",
        },
    ]
    formatted_runs = []
